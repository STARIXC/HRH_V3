                ...
                <div class="card">
                  <div class="card-content">
                    <div class="card-body">
                      ...
                      <%
                        if (session.getAttribute("emp_type") != null) {
                      %>
                      <%
                        if (session.getAttribute("emp_type").toString().equals("3")) {
                      %>
                      <div class="row">
                      ...
                      <%
                        ...
                        if (session.getAttribute("emp_type").toString().equals("1")) {
                      %>
                      <div class="row">
                        <div class="col-sm-12 col-md-12">
                          <div class="card_">
                      ...
                      <%
                        ...
                        if (session.getAttribute("emp_type").toString().equals("2")) {
                      %>
                      <div class="row">
                        <div class="col-sm-12 col-md-12">
                          <div class="card-">
