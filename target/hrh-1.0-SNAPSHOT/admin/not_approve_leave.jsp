...
<div id="main">
    ...
    <div class="main-content container-fluid">
        ...
        <section class="section">
            <div class="card">
                <div class="card-body">
                    <table class='table table-hover datatable responsive' id="notapproved_leave_table">
                        <thead>
                            <tr>
                                <th>Name</th>
                                <th>Employee Id</th>
                        ...
                        <tbody id="notapproved_leave_table_data">
...
<script src="../assets/js/pages/notapproved_leave.js"></script>
