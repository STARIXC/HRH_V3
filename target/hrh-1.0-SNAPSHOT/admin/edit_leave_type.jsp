...
<link rel="shortcut icon" href="../assets/img/logo.png" type="image/x-icon">
    ...
    <body>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group has-icon-left">
                                                        ...
                                                        <div class="position-relative">
                                                            <input type="hidden" class="form-control" placeholder="Input leave type" id="leave_type_id" name="leave_type_id" value="<%=id%>">
        ...
        <script src="../assets/js/pages/leave_type_.js"></script>
