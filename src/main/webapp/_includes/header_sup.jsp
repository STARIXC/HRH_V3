...
if (session.getAttribute("sup_login")==null || session.getAttribute("sup_login")=="") {
...
<div id="app">
    <div id="sidebar" class='active'>
        <div class="sidebar-wrapper active">
            ...
            <!-- BEGIN SIDEBAR MENU -->         
            <%@include file="/_includes/sup_sidebar_menu.jsp"%>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul
                    ...
                    <li class="dropdown"><a href="#" data-bs-toggle="dropdown"
                            ...
                            <div class="d-none d-md-block d-lg-inline-block welcome">Hi, <%=session.getAttribute("sup_login")%></div>
                        </a>
