                ...
                <div class="col-md-8 order-md-1 order-last">
                    <nav aria-label="breadcrumb" class='breadcrumb-header'>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Leave Entitlements</li>
                        </ol>
                    </nav>
                </div>
                        ...
                        <div class="card-wrapper " aria-expanded="true">
                            <div class="card-body">
                                <div class="table-responsive ">
                                    <table width="100%" class="leave_entitlement_table table  table-bordered table-hover " id="leave_entitlement_table">
                                        <thead class='mt-3'>
                                            <tr>
                                                <td id="cb" >
                                        ...
                                        <tbody id="leave_entitlement_table_data">
