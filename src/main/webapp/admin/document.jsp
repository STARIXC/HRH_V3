                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modal-title">Create New  Document Type</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="body">
                                <form method="POST" id="DocumentForm" accept-charset="UTF-8">
                                    <div class="modal-body">
                                        <div class="row">
                                            <input type="hidden" class="form-control doc_id input-width-xlarge" name="doc_id" id="doc_id" >
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    <label for="name" class="form-label">Name</label>
                                                    <div class="form-icon-user">
                                                        <input class="form-control" placeholder="Enter Document Name" name="name" type="text" id="name">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        <textarea value="" maxlength="200" id="description_" class="form-control input-width-xlarge" name="description_" rows="5" cols="10"></textarea>
                    ...
                    success: function (data) {
                        ...
                        $.each(data, function (i, docType) {
                            ...
                            let tb = '<tr><td>' + docType.name + '</td><td>' + docType.description + '</td><td><h6 class="float-left mr-1">' + status + '</h6> </td>'
                                    ...
                                    + '      <a href="javascript:void(0);"  data-id="' + docType.id + '" class="mx-3 btn btn-sm  align-items-center edit-doc"'
                                    ...
                                    + ' <a href="javascript:void(0);"  data-id="' + docType.id + '" class="deleteBtn mx-3 btn btn-sm  align-items-center bs-pass-para"'
                                    + '   data-bs-toggle="tooltip" title="" data-bs-original-title="Delete"'
                                    + '   aria-label="Delete"><i'
                                    + ' class="fa fa-trash text-white text-white"></i></a>'
