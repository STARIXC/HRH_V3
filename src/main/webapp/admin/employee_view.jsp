                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="profile-head">
                                ...
                                <p class="proile-rating">Supervisor : <span>8/10</span></p>
                                ...
                                <div class="tab-pane  show active" id="basic" role="tabpanel" aria-labelledby="basic-tab">
                                    ...
                                    <div class="card shadow">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="#" id="education-add" class="btn btn-outline-primary add_work_record" data-bs-id=""
                                               data-template="employ-education"
                                               data-title="Add Education"><i class="fa fa-plus"></i> Add Record</a>
                                        </div>
                                    </div>
                                    <div class="card shadow">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="#" id="education-add" class="btn btn-outline-primary" data-bs-id=""
                                               data-template="employ-education"
                                               data-title="Add Education"><i class="fa fa-plus"></i> Add Education</a>
                                        </div>
                                    </div>
                                    <div class="card shadow">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="#" id="dependents-add" class="btn btn-outline-primary" data-bs-id=""
                                               data-template="employ-dependents"
                                               data-title="Add Dependents"><i class="fa fa-plus"></i> Add Dependents</a>
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        var app="/hrh";
        $(document).on('click', '.add_work_record', function (e) {
            $('#simpleModalWork form')[0].reset();
            $("#simpleModalWork").modal('show');
        });
...
//                enctype: 'multipart/form-data',
        ...
        $('#wddlFacility').change(function () {
            ...
            $.ajax({
                ...
                dataType: "json",
                success: function (data) {
                    $('#wddlSupervisor').empty();
                    $('#wddlSupervisor').append('<option value="">--- Select Supervisor---</option>');
                    $.each(data, function (key, value)
                    {
                        $('#wddlSupervisor').append('<option value="' + value.supervisor_id + '">' + value.name + '</option>');
                    });
        ...
        $("#wtxtJoinDate").datepicker({
            dateFormat: "yy-mm-dd"
        });
        $("#wtxtTerminateDate").datepicker({
            dateFormat: "yy-mm-dd"
        });
        $("#wtxtRehiredate").datepicker({
            dateFormat: "yy-mm-dd"
        });
        $("#wtxtBirthDate").datepicker({
            dateFormat: "yy-mm-dd"
        });
...
//            $("#ddlEmployeeType").html(data);
    ...
    function pataStandard() {
        let emp_type = document.getElementById("wddlEmployeeType").value;
...
//                $('#ddlCadreCategory').append('<option value="' + value.id + '">' + value.standardized_cadre_name + '</option>');
    ...
    function pataPositions() {
        let cadre = document.getElementById("wddlCadreCategory").value;
        //var county = $('#county').val();
        console.log(cadre);
        $.ajax({
...
//                    $('#ddlPos').append('<option value="' + value.id + '">' + value.position_title + '</option>');
    ...
    function patafydetails() {
        var year_id = document.getElementById("wddlFY").value;
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                document.getElementById('wcontract_period').value = data.contract_period;
                document.getElementById('wend_date').value = data.end_date;
                document.getElementById('wcontract_no_months').value = data.contract_no_months;
//            document.getElementById('start_date').value = data.start_date;
                document.getElementById('wyear').value = data.year;
