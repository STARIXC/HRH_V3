...
//                $("#_designation").text(data.currentPosition.position);
                ...
                $("#facility").text(data.employee.current_facility);
                $("#_facility").text(data.employee.current_facility);
//                        $("#title").text(data.positionTitle);
                $("#ecode").text(data.employee.emp_no);
                $("#hireDate").text(data.employee.date_started);
//                        $("#etype").text(data.cadreTypeName);
                ...
                $("#supervisor").text(data.employee.supervisor);
